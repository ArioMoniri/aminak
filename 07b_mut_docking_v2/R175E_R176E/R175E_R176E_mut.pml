...
cmd.get_wizard().set_mode("GLU")
cmd.get_wizard().do_select("/prot//A/176/")
best_strain = 1e30
best_idx = 0
n_rot = 0
try:
...
try:
    ...
    pass
print("ROTAMER_PICK resi=176 aa=GLU best_idx=" + str(best_idx) + " strain=" + str(best_strain))
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/R175E_R176E/R175E_R176E_mut.pdb, prot