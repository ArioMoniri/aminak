...
try:
    ...
    pass
print("ROTAMER_PICK resi=195 aa=SER best_idx=" + str(best_idx) + " strain=" + str(best_strain))
...
try:
    ...
    pass
print("ROTAMER_PICK resi=196 aa=ASN best_idx=" + str(best_idx) + " strain=" + str(best_strain))
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/C195S_H196N/C195S_H196N_mut.pdb, prot