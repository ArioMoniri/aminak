...
cmd.get_wizard().do_select("/prot//A/217/")
best_strain = 1e30
best_idx = 0
n_rot = 0
try:
...
try:
    ...
    pass
print("ROTAMER_PICK resi=217 aa=TRP best_idx=" + str(best_idx) + " strain=" + str(best_strain))
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/G217W/G217W_mut.pdb, prot