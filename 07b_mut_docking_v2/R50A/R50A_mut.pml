...
try:
    ...
    pass
print("ROTAMER_PICK resi=50 aa=ALA best_idx=" + str(best_idx) + " strain=" + str(best_strain))
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/R50A/R50A_mut.pdb, prot