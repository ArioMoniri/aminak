...
try:
    ...
    pass
print("ROTAMER_PICK resi=215 aa=GLU best_idx=" + str(best_idx) + " strain=" + str(best_strain))
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/R215E/R215E_mut.pdb, prot