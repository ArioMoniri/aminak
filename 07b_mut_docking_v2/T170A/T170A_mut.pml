...
cmd.get_wizard().do_select("/prot//A/170/")
best_strain = 1e30
best_idx = 0
n_rot = 0
try:
...
try:
    ...
    pass
print("ROTAMER_PICK resi=170 aa=ALA best_idx=" + str(best_idx) + " strain=" + str(best_strain))
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/T170A/T170A_mut.pdb, prot