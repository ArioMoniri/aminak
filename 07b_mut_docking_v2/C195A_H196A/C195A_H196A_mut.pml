...
try:
    ...
    pass
print("ROTAMER_PICK resi=195 aa=ALA best_idx=" + str(best_idx) + " strain=" + str(best_strain))
...
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/C195A_H196A/C195A_H196A_mut.pdb, prot