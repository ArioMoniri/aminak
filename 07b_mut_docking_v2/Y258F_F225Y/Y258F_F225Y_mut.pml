...
try:
    ...
    pass
print("ROTAMER_PICK resi=258 aa=PHE best_idx=" + str(best_idx) + " strain=" + str(best_strain))
...
try:
    ...
    pass
print("ROTAMER_PICK resi=225 aa=TYR best_idx=" + str(best_idx) + " strain=" + str(best_strain))
cmd.get_wizard().apply()
set_wizard
save /Users/ario/conserved_site_project/07b_mut_docking_v2/Y258F_F225Y/Y258F_F225Y_mut.pdb, prot